  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-[25%] left-[10%] animate-pulse opacity-20"><Image src={hero3} alt="" width={150} height={150} /></div>
        <div className="absolute top-[45%] right-[3%] animate-pulse opacity-30"><Image src={hero4} alt="" width={200} height={200} /></div>
        <div className="absolute bottom-[15%] right-[12%] animate-pulse opacity-25"><Image src={hero5} alt="" width={180} height={180} /></div>
